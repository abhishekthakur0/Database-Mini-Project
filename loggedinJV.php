...
<div id="Insert" class="tabcontent">
 <form action="a_insert.php" method="POST" onsubmit="return executeOnSubmit();"><br>
Case No.:<input type="text" name="j_case" required >
Judgement or Order Date:<input type="text" name="j_date" required>
